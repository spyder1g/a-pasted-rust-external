...
uint64_t get_process_base_address(const SOCKET connection, const uint32_t exe_id)
{
	Packet packet{ };
	J();
	packet.header.magic = packet_magic;
...
uint64_t get_dll(const SOCKET connection, const uint32_t process_id, int module)
{
	Packet packet{ };
	J();
	packet.header.magic = packet_magic;
...
uint64_t clean_piddbcachetable(const SOCKET connection)
{
	Packet packet{ };
	J();
	packet.header.magic = packet_magic;
...
uint64_t clean_mmunloadeddrivers(const SOCKET connection)
{
	Packet packet{ };
	J();
	packet.header.magic = packet_magic;
...
uint64_t spoof_drives(const SOCKET connection)
{
	Packet packet{ };
	J();
	packet.header.magic = packet_magic;
